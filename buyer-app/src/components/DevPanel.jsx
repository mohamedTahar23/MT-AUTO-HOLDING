...
/**
 * Floating navigator shown only while dev mode is on. It drives the app through
 * the same handlers the product uses (`app` prop bag), so nothing here is a
 * parallel code path — it just skips the gates.
 */
