...
// localStorage. When on, <DevPanel> can sign in (mock `_devSignIn`) and jump to
// any screen / account modal without going through the auth flow.
// ---------------------------------------------------------------------------
import { useEffect, useState } from 'react'

const KEY = 'mtseller.devmode'
